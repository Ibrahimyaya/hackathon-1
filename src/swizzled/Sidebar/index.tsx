  ...
  const defaultModules: Module[] = [
    {
      ...
      chapters: [
        { id: 'ch1-1', title: 'ROS 2 Overview', documentId: 'part1-foundations/01-ros2-overview' },
        { id: 'ch1-2', title: 'DDS Concepts', documentId: 'part1-foundations/02-dds-concepts' },
        { id: 'ch1-3', title: 'Why Humanoids', documentId: 'part1-foundations/03-why-humanoids' },
      ],
    },
    {
      id: 'module-2',
      ...
      chapters: [
        { id: 'ch2-1', title: 'Nodes & Lifecycle', documentId: 'part2-communication/04-nodes-and-lifecycle' },
        { id: 'ch2-2', title: 'Topics & PubSub', documentId: 'part2-communication/05-topics-pubsub' },
        { id: 'ch2-3', title: 'Services & ReqRep', documentId: 'part2-communication/06-services-reqrep' },
        { id: 'ch2-4', title: 'Actions & Async', documentId: 'part2-communication/07-actions-async' },
        { id: 'ch2-5', title: 'Agent Controller Example', documentId: 'part2-communication/08-agent-controller-example' },
      ],
    },
    {
      id: 'module-3',
      name: 'Isaac Brain',
      chapters: [
        { id: 'ch3-1', title: 'URDF Fundamentals', documentId: 'part3-robot-structure/09-urdf-fundamentals' },
        { id: 'ch3-2', title: 'Humanoid URDF Example', documentId: 'part3-robot-structure/10-humanoid-urdf-example' },
        { id: 'ch3-3', title: 'RViz Gazebo Integration', documentId: 'part3-robot-structure/11-rviz-gazebo-integration' },
      ],
    },
    {
      id: 'module-4',
      ...
      chapters: [
        { id: 'ch4-1', title: 'Gazebo Fundamentals', documentId: 'part4-gazebo-simulation/12-gazebo-fundamentals' },
        { id: 'ch4-2', title: 'Physics Simulation', documentId: 'part4-gazebo-simulation/13-physics-simulation' },
        { id: 'ch4-3', title: 'Humanoid Gazebo World', documentId: 'part4-gazebo-simulation/14-humanoid-gazebo-world' },
        { id: 'ch4-4', title: 'Gazebo Sensors', documentId: 'part4-gazebo-simulation/15-gazebo-sensors' },
        { id: 'ch4-5', title: 'Sensor Streaming ROS2', documentId: 'part4-gazebo-simulation/16-sensor-streaming-ros2' },
        { id: 'ch4-6', title: 'Advanced Physics', documentId: 'part4-gazebo-simulation/17-gazebo-advanced-physics' },
      ],
    },
  ];
